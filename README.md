...
1. **Clona el repositorio:**
   ...
   ```bash
   git clone https://github.com/tu-usuario/mayoral-assignment.git
...
Puedes ver la demo del proyecto en el siguiente enlace: [DEMO](https://mayoral-assignment-production.up.railway.app/)